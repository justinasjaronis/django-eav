...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnumValue.icon_pdf'
        db.add_column(u'eav_enumvalue', 'icon_pdf',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnumValue.icon_pdf'
        db.delete_column(u'eav_enumvalue', 'icon_pdf')
    ...
    models = {
        ...
        u'eav.attribute': {
            'Meta': {'ordering': "['position', 'name']", 'unique_together': "(('site', 'slug'),)", 'object_name': 'Attribute'},
            ...
            'value_suffix': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'blank': 'True'})
        },
        u'eav.enumgroup': {
        ...
        u'eav.enumvalue': {
            ...
            'icon': ('django.db.models.fields.files.ImageField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'icon_pdf': ('django.db.models.fields.files.ImageField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
