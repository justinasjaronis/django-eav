...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnumValue.icon'
        db.add_column(u'eav_enumvalue', 'icon',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Attribute.position'
        db.add_column(u'eav_attribute', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnumValue.icon'
        db.delete_column(u'eav_enumvalue', 'icon')

        # Deleting field 'Attribute.position'
        db.delete_column(u'eav_attribute', 'position')
